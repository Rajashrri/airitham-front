      ...
      <React.Fragment>
        <div id="sidebar-menu">
          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/blogcategory-master" className="waves-effect">
                <i className="mdi mdi-account-key-outline"></i> 
                <span className="ms-1">{this.props.t('Blog Category Master')}</span>
              </Link>
            </li>
             
           
          <li>
            <Link to="/blog-list" className="waves-effect">
          ...
          <li>
            <Link to="/testimonial-list" className="waves-effect">
