      ...
      <Row className="mb-2">
        ...
        <Col md={6}>
          <div className="d-flex justify-content-end">
            <Link color="primary" to="/create-blog" className="btn btn-primary">
              Add
            </Link>
          </div>
        </Col>
...
const EmployeeList = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: "Category",
        accessor: "category_id", // this is the role ID
      ...
      },
      {
        ...
        Cell: ({ row }) => (
          <div className="d-flex gap-2">
            <Link
              color="primary"
              to={`/update-blog/${row.original._id}`}
  ...
  return (
    <Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="BLOG" breadcrumbItems={breadcrumbItems} />
          <Card>
            <CardBody>
              <TableContainer
                columns={columns}
